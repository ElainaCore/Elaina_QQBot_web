  ...
  'fixed z-50 gap-4 bg-card p-0 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 outline-none',
  {
    variants: {
      side: {
        ...
        left: 'inset-y-0 left-0 h-full w-full max-w-full border-r data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:w-[min(92vw,28rem)]',
        right: 'inset-y-0 right-0 h-full w-full max-w-full border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:w-[min(92vw,28rem)]',
      },
    },
