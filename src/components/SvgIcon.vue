...
const ICONS = {
  ...
  time: '<circle cx="12" cy="12" r="9"/><polyline points="12 7 12 12 16 14"/><line x1="12" y1="3" x2="12" y2="5"/><line x1="12" y1="19" x2="12" y2="21"/>',
  flame: '<path d="M13.5 2.5c.7 4-2.2 5.2-3.4 7.6-.7 1.4-.2 2.8 1 3.7-.2-2.1 1.1-3.3 2.5-4.5 2.1 1.6 3.4 3.7 3.4 6.1A5 5 0 017 15c0-3.2 2-5.3 3.8-7.4 1.2-1.4 2.2-2.8 2.7-5.1z"/><path d="M12 21c-1.8-.7-2.8-2-2.8-3.6 0-1.2.6-2.2 1.5-3.2.1 1.1.7 1.8 1.4 2.3.6-.9 1.2-1.7 1.9-2.3.6.9.9 1.8.9 2.8 0 1.8-1.1 3.2-2.9 4z"/>',
  chip: '<rect x="6" y="6" width="12" height="12" rx="2"/><rect x="9" y="9" width="6" height="6" rx="1"/><line x1="9" y1="2" x2="9" y2="6"/><line x1="15" y1="2" x2="15" y2="6"/><line x1="9" y1="18" x2="9" y2="22"/><line x1="15" y1="18" x2="15" y2="22"/><line x1="2" y1="9" x2="6" y2="9"/><line x1="18" y1="9" x2="22" y2="9"/><line x1="2" y1="15" x2="6" y2="15"/><line x1="18" y1="15" x2="22" y2="15"/>',
  memory: '<rect x="3" y="6" width="18" height="12" rx="2"/><rect x="7" y="9" width="3" height="6"/><rect x="14" y="9" width="3" height="6"/><line x1="6" y1="3" x2="6" y2="6"/><line x1="10" y1="3" x2="10" y2="6"/><line x1="14" y1="3" x2="14" y2="6"/><line x1="18" y1="3" x2="18" y2="6"/><line x1="6" y1="18" x2="6" y2="21"/><line x1="10" y1="18" x2="10" y2="21"/><line x1="14" y1="18" x2="14" y2="21"/><line x1="18" y1="18" x2="18" y2="21"/>',
  folder: '<path d="M3 6a2 2 0 012-2h5l2 3h7a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><path d="M3 10h18"/>',
  ...
  robot: '<rect x="5" y="7" width="14" height="12" rx="3"/><path d="M12 3v4"/><circle cx="12" cy="2.5" r="1" fill="currentColor" stroke="none"/><circle cx="9" cy="12" r="1.2" fill="currentColor" stroke="none"/><circle cx="15" cy="12" r="1.2" fill="currentColor" stroke="none"/><path d="M9 16h6"/>',
  person: '<circle cx="12" cy="8" r="3.5"/><path d="M4 21c.7-4.1 3.4-6.5 8-6.5s7.3 2.4 8 6.5"/>',
  'qr-code': '<rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><path d="M14 14h3v3h-3zM18 18h3v3h-3zM18 14h3M14 18h1"/>',
  'checkmark-circle': '<circle cx="12" cy="12" r="9"/><polyline points="8 12 11 15 16 9"/>',
  'close-circle': '<circle cx="12" cy="12" r="9"/><line x1="9" y1="9" x2="15" y2="15"/><line x1="15" y1="9" x2="9" y2="15"/>',
  upload: '<polygon points="12 2 20 7 20 17 12 22 4 17 4 7"/><polyline points="12 16 12 9"/><polyline points="9 11 12 8 15 11"/>',
  download: '<polygon points="12 2 20 7 20 17 12 22 4 17 4 7"/><polyline points="12 8 12 15"/><polyline points="9 13 12 16 15 13"/>',
